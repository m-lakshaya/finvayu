  ...
  return (
    <header className="h-20 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-b border-white/20 dark:border-white/10 flex items-center justify-between px-8 flex-shrink-0 z-10 transition-all duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer hover:bg-white dark:hover:bg-white/5 p-1.5 rounded-2xl transition-all group border border-transparent hover:border-white/40 dark:hover:border-white/10">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-bold leading-none text-slate-900 dark:text-white">Sarah Jenkins</p>
            <p className="text-[10px] font-bold text-primary uppercase tracking-widest mt-1">Branch Manager</p>
          </div>
          ...
          <ChevronDown className="text-slate-400 group-hover:text-primary transition-colors" size={16} />
        </div>
      </div>
    </header>
  );
