...
const Dashboard = () => {
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      ...
      const isPartner = ['collaborator', 'banker'].includes(roleName);
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:shadow-lg hover:shadow-primary/20 transition-all">
